...
import { uploadPolicyDocument, handleUploadError } from "../middleware/upload.middleware.js";
...
router.post("/policies/upload", uploadPolicyDocument, handleUploadError, policyController.uploadPolicyDocument);
router.post("/policies/confirm", policyController.confirmPolicyData);
router.get("/policies/pending-extractions", policyController.getPendingExtractions);
